...
updated: '2025-11-12 14:18:57'
---
| **<font style="background-color:rgba(255, 255, 255, 0);">特性</font>** | **<font style="background-color:rgba(255, 255, 255, 0);">ARM (AArch32)</font>** | **<font style="background-color:rgba(255, 255, 255, 0);">aarch64</font>** |
| :--- | :--- | :--- |
| **<font style="background-color:rgba(255, 255, 255, 0);">全称/标准名称</font>** | <font style="background-color:rgba(255, 255, 255, 0);">ARM 32-bit Execution State</font> | <font style="background-color:rgba(255, 255, 255, 0);">ARM 64-bit Execution State</font> |
| **<font style="background-color:rgba(255, 255, 255, 0);">所属架构</font>** | <font style="background-color:rgba(255, 255, 255, 0);">ARMv7 及更早, ARMv8-A 的兼容模式</font> | <font style="background-color:rgba(255, 255, 255, 0);">ARMv8-A 及更高版本</font> |
| **<font style="background-color:rgba(255, 255, 255, 0);">数据宽度</font>** | <font style="background-color:rgba(255, 255, 255, 0);">32 位</font> | <font style="background-color:rgba(255, 255, 255, 0);">64 位</font> |
| **<font style="background-color:rgba(255, 255, 255, 0);">寄存器</font>** | <font style="background-color:rgba(255, 255, 255, 0);">16 个通用寄存器 (R0-R15)，32位宽</font> | <font style="background-color:rgba(255, 255, 255, 0);">31 个 64 位通用寄存器 (X0-X30)，兼容访问低32位 (W0-W30)</font> |
| **<font style="background-color:rgba(255, 255, 255, 0);">地址空间</font>** | <font style="background-color:rgba(255, 255, 255, 0);">最大 4GB (2^32)</font> | <font style="background-color:rgba(255, 255, 255, 0);">理论最大 2^64 字节，实际实现通常为 48 位 (256TB) 或 52 位</font> |
| **<font style="background-color:rgba(255, 255, 255, 0);">性能潜力</font>** | <font style="background-color:rgba(255, 255, 255, 0);">相对较低</font> | <font style="background-color:rgba(255, 255, 255, 0);">更高（得益于更多寄存器、更高效的指令编码等）</font> |
| **<font style="background-color:rgba(255, 255, 255, 0);">常见应用场景</font>** | <font style="background-color:rgba(255, 255, 255, 0);">老款智能手机、嵌入式微控制器 (MCU)、物联网设备</font> | <font style="background-color:rgba(255, 255, 255, 0);">现代智能手机、平板电脑、服务器、高性能嵌入式设备</font> |
