---
title: BinaryNinja安装
date: '2025-11-14 15:25:03'
updated: '2025-11-17 21:47:34'
---
版本5.1.8104

先用安装包装完之后再在安装目录下找到`binaryninjacore.dll`，拷贝到跟 patch 脚本同一路径：
...
然后运行脚本，得到一个备份文件和正常的 dll，把 dll 替换掉安装目录下面原本的 dll
...
再打开 binaryninja 选中生成的证书文件，就成功激活了
